...
interface ImageGalleryProps<T extends ImageItem> {
  items: T[];
  onItemClick?: (item: T) => void;
  layoutIdPrefix?: string;
}

function Gallery<T extends ImageItem>({ 
  items, 
  setIndex, 
  setOpen, 
  index,
...
export default function ImageGallery<T extends ImageItem>({ 
  items, 
  onItemClick,
  layoutIdPrefix = 'image'
}: ImageGalleryProps<T>) {
        ...
        {open && currentItem && (
          ...
          >
            <div onClick={(e) => e.stopPropagation()}>
              <motion.div
                layoutId={`${layoutIdPrefix}-${currentItem.id}`}
              ...
              >
                <img
                  src={currentItem.thumbnail_url || currentItem.image_url}
