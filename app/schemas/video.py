...
class VideoBase(BaseModel):
    ...
    video_url: str = Field(..., max_length=500, description="原画视频URL")
    thumbnail_video_url: Optional[str] = Field(None, max_length=500, description="缩略视频URL（最大压缩）")
    video_url_480p: Optional[str] = Field(None, max_length=500, description="标清视频URL（480p）")
    video_url_720p: Optional[str] = Field(None, max_length=500, description="高清视频URL（720p）")
    cover_image: Optional[str] = Field(None, max_length=500, description="视频封面图片URL")
    ...
    file_size: Optional[int] = Field(None, description="原画视频文件大小（字节）")
    thumbnail_file_size: Optional[int] = Field(None, description="缩略视频文件大小（字节）")
    video_url_480p_size: Optional[int] = Field(None, description="标清视频文件大小（字节）")
    video_url_720p_size: Optional[int] = Field(None, description="高清视频文件大小（字节）")
...
class VideoUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, description="视频描述")
    video_url: Optional[str] = Field(None, max_length=500, description="原画视频URL")
    thumbnail_video_url: Optional[str] = Field(None, max_length=500, description="缩略视频URL（最大压缩）")
    video_url_480p: Optional[str] = Field(None, max_length=500, description="标清视频URL（480p）")
    video_url_720p: Optional[str] = Field(None, max_length=500, description="高清视频URL（720p）")
    cover_image: Optional[str] = Field(None, max_length=500, description="视频封面图片URL")
