...
export default function VideoCategoryList() {
  ...
  const handleSubmit = async (values: any) => {
    try {
      if (editingCategory) {
        await api.put(`/videos/categories/${editingCategory.id}`, values)
        message.success('更新成功')
      } else {
        await api.post('/videos/categories', values)
  ...
  return (
    <div className="page-shell">
      <PageHeader
        title="视频分类"
        description="为视频设置主题，搭配封面图片即刻用于前端展示。"
